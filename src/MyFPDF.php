...
{ 
    ...
    $this->Cell(50,20,'Fecha: '.$today,'',1,'R');
    $this->SetTextColor(50,50,150);
    $this->SetFont('Arial','B',15);
    $this->Cell(0,5,'Concesionario De Carros',0,1,'C');
    $this->Cell(0,10,'',0,1,'C');
    $this->Image('../img/chevrolet2.png',10,20,60); //derecha
	$this->Image('../img/chevrolet2.png',140,20,60);
}
...
function Footer()
{
    ...
    //Número de página
    $this->Cell(0,13,'Pagina '.$this->PageNo().'/{nb}',0,0,'C');
 }
